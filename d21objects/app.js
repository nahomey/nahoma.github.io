...
//module.exports = { findTitles, addBook, showTitles, findAuthors, showAuthors, findIDs, scramble }; //add all of your function names here that you need for the node mocha tests
